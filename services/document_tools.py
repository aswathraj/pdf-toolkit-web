...
TOOL_DEFINITIONS = [
    {
        "key": "jpg-to-pdf",
        "title": "JPG to PDF",
        "summary": "Combine images into a single polished PDF.",
        "multiple": True,
        "accept": ".jpg,.jpeg,.png,.webp,.bmp,.tif,.tiff",
        "button": "Convert to PDF",
        "badge": "Convert",
        "category": "convert",
        "formats_help": "JPG, JPEG, PNG, WEBP, BMP, TIFF",
    },
    {
        "key": "pdf-to-jpg",
        "title": "PDF to JPG",
        "summary": "Export each PDF page as a high-quality JPG image.",
        "multiple": False,
        "accept": ".pdf",
    ...
    },
    {
        ...
        "summary": "Resize images by pixels, set DPI, and convert formats.",
        "multiple": True,
        "accept": ".jpg,.jpeg,.png,.webp,.bmp,.tif,.tiff",
        "button": "Resize image",
        "badge": "Convert",
    ...
    },
    {
        "key": "word-to-pdf",
        "title": "Word to PDF",
        "summary": "Turn DOCX files into clean, readable PDFs.",
        "multiple": True,
        "accept": ".docx",
        "button": "Convert to PDF",
        "badge": "Convert",
    ...
    },
    {
        "key": "pdf-to-word",
        "title": "PDF to Word",
        "summary": "Extract PDF text into an editable DOCX file.",
        "multiple": True,
        "accept": ".pdf",
        "button": "Convert to DOCX",
        "badge": "Extract",
        "category": "extract",
        "formats_help": "PDF",
    },
    {
        "key": "excel-to-pdf",
        "title": "Excel to PDF",
        "summary": "Turn spreadsheet sheets into paginated PDFs.",
        "multiple": True,
        "accept": ".xlsx,.xlsm",
        "button": "Convert to PDF",
        "badge": "Convert",
        "category": "convert",
        "formats_help": "XLSX, XLSM",
    },
    {
        "key": "pdf-to-excel",
        "title": "PDF to Excel",
        "summary": "Extract table data from PDFs into XLSX.",
        "multiple": True,
        "accept": ".pdf",
    ...
    },
    {
        "key": "merge-pdf",
        "title": "Merge PDF",
        "summary": "Combine multiple PDFs in the order you upload them.",
        "multiple": True,
        "accept": ".pdf",
        "button": "Merge PDFs",
        "badge": "Organize",
    ...
    },
    {
        "key": "split-pdf",
        "title": "Split PDF",
        "summary": "Split a PDF by page or custom page ranges.",
        "multiple": False,
        "accept": ".pdf",
        "button": "Split PDF",
        "badge": "Organize",
    ...
    },
    {
        ...
        "summary": "Remove watermark text and unwanted PDF annotations.",
        "multiple": True,
        "accept": ".pdf",
        "button": "Clean PDF",
        "badge": "Repair",
    ...
    },
    {
        "key": "ocr-pdf",
        "title": "OCR PDF",
        "summary": "Make scanned PDFs and images searchable with OCR.",
        "multiple": True,
        "accept": ".pdf,.jpg,.jpeg,.png,.webp,.bmp,.tif,.tiff",
        "button": "Run OCR",
        "badge": "OCR",
        "category": "ocr",
        "formats_help": "PDF, JPG, JPEG, PNG, WEBP, BMP, TIFF",
    },
]
